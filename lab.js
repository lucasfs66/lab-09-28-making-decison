...
if (amysAge > brittanisAge) {
  ...
  console.log("They both have the same age")
}
...
/*
  ...
  born in the same year. If they were, console.log 'Amy & Brittani were born in the same year'. 
...
/*
  Using an if statement and a comparison operator, create code that will log a
   suggestion on what type of clothes one should wear for the day, based on the above temperature
    and rain.
  If it is 80 degrees or above, and raining, one should wear a t-shirt and take an umbrella.
   If it is between 60 and 80 degrees, and raining, one should wear a rain-jacket.
    ...
    Come up with your own clothing suggestions based on those temperature parameters when
     it is not raining.
*/
...
if (temperature === 80 && rain === true) {
  ...
  console.log("there is no need to a umbrella")
}
